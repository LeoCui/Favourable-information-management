...
public class ItemDao {
	...
	public Item getItemByItemID(int itemID)throws SQLException{
		...
		while(resultSet.next()){
			...
			String adderss=market.getMarketCity()+market.getMarketArea()+market.getMarketBlock()+"";
	...
	public List<Item> getItemByItemName(String itemName1)throws SQLException{
		String sql = "select * from "+marketTable+" where itemName like '%"+itemName1+"%'";
		//String sql="select * from "+marketTable+" where itemName='"+itemName1+"'";
		// ? 的坑大大的
		PreparedStatement preparedStatement = connection.prepareStatement(sql);
